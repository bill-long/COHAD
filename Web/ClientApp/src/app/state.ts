...
export class AuthenticatedUserChanged {
  constructor(public authUser: AuthUser | null) {}
}
...
export class LoadDirectoryCompleted {
  constructor(public data: DirectoryHome[]) {}
}

export class LoadUser {}

export class LoadUserCompleted {
  constructor(public user: ApiUser | null) {}
}
...
export function applicationStateFactory(initialState: ApplicationState, dispatcher: Observable<Action>): Observable<ApplicationState> {
  const appStateObservable = dispatcher.pipe(
