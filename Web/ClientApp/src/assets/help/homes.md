...
Every home in the neighborhood, with its contact details and residents. This is the same editor residents use for their own home, but here you can edit any home on their behalf.
...
- **You cannot remove your own association.** The account you are signed in with shows *Your account* instead of a Remove button, on this screen and on My Info, so a resident cannot lock themselves out of their own home. Another owner of the home, or another administrator, can remove it - or edit the account's home list in [Users](#topic:users).
