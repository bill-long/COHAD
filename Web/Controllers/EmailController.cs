...
namespace Web.Controllers
{
    ...
    public class EmailController : ControllerBase
    {
        ...
        public async Task<IActionResult> SendEmailFromBoard([FromBody] EmailInfo emailInfo)
        {
            ...
            await _emailService.SendEmail("board@cohad.org", "COHAD Board", emailInfo, e => e != null && e.BoardEmailOptedIn, "Canyon Oaks Residents", "board", User);
        ...
        public async Task<IActionResult> SendEmailFromWelcomeCommittee([FromBody] EmailInfo emailInfo)
        {
            ...
            await _emailService.SendEmail("welcome@cohad.org", "COHAD Welcome Committee", emailInfo, e => e != null && e.WelcomeEmailOptedIn, "Canyon Oaks Residents", "welcome", User);
        ...
        public async Task<IActionResult> SendEmailFromGardenClub([FromBody] EmailInfo emailInfo)
        {
            ...
            await _emailService.SendEmail("gardenclub@cohad.org", "COHAD Garden Club", emailInfo, e => e != null && e.GardenClubEmailOptedIn, "Canyon Oaks Residents", "garden", User);
        ...
        public async Task<IActionResult> SendEmailFromSocialCommittee([FromBody] EmailInfo emailInfo)
        {
            ...
            await _emailService.SendEmail("social@cohad.org", "COHAD Social Committee", emailInfo, e => e != null && e.SocialCommitteeEmailOptedIn, "Canyon Oaks Residents", "social", User);
        ...
        public async Task<IActionResult> SendEmailFromSunshineCommittee([FromBody] EmailInfo emailInfo)
        {
            ...
            await _emailService.SendEmail("sunshine@cohad.org", "COHAD Sunshine Committee", emailInfo, e => e != null && e.SunshineCommitteeEmailOptedIn, "Canyon Oaks Residents", "sunshine", User);
