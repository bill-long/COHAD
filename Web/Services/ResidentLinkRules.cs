...
namespace Web.Services
{
    ...
    /// usable: the resident exists, lives in one of the user's owned homes, and is not a child.
    /// Every site that validates, clears, or resolves through a link must use this predicate so the
    /// invariant cannot drift between the write paths and the readers.
    /// </summary>
