...
namespace Web.UnitTests
{
    ...
    public class EmailDeliveryActionServiceTests
    {
        ...
        [Fact]
        public async Task RepeatBounce_IncrementsTheExistingRecord()
        {
            var service = CreateService();
            await service.ProcessDeliveryEventAsync(NewEvent(), null);
            await service.ProcessDeliveryEventAsync(NewEvent(diagnostic: "HardBounce: mailbox full"), null);
