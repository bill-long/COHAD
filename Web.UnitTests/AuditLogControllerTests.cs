...
public sealed class AuditLogControllerTests
{
    ...
    public async Task Get_uses_default_limit_50_when_limit_null()
    {
        ...
        mock.Setup(r => r.GetPageAsync(50, null, null)).ReturnsAsync(new AuditLogPage()).Verifiable();
    ...
    {
        var mock = new Mock<IAuditLogRepository>(MockBehavior.Strict);
        mock.Setup(r => r.GetPageAsync(50, null, null)).ReturnsAsync(new AuditLogPage());
    ...
    {
        var mock = new Mock<IAuditLogRepository>(MockBehavior.Strict);
        mock.Setup(r => r.GetPageAsync(200, null, null)).ReturnsAsync(new AuditLogPage());
    ...
    {
        var mock = new Mock<IAuditLogRepository>(MockBehavior.Strict);
        mock.Setup(r => r.GetPageAsync(50, "from-header", null)).ReturnsAsync(new AuditLogPage());
    ...
    {
        var mock = new Mock<IAuditLogRepository>(MockBehavior.Strict);
        mock.Setup(r => r.GetPageAsync(50, "from-query", null)).ReturnsAsync(new AuditLogPage());
    ...
    {
        var mock = new Mock<IAuditLogRepository>(MockBehavior.Strict);
        mock.Setup(r => r.GetPageAsync(50, null, "  find me  ")).ReturnsAsync(new AuditLogPage());
